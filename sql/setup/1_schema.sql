...
CREATE TABLE IF NOT EXISTS `login_bonus_masters` (
  `id` bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS `login_bonus_reward_masters` (
  `id` bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS `present_all_masters` (
  `id` bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_present_all_received_history` (
  `id` bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gacha_item_masters` (
  `id` bigint NOT NULL,
...
/*　マスタバージョンを管理するテーブル */
CREATE TABLE IF NOT EXISTS `version_masters` (
  `id` bigint NOT NULL,
...
TRUNCATE TABLE `user_one_time_tokens`;
TRUNCATE TABLE `users`;
TRUNCATE TABLE `user_decks`;
TRUNCATE TABLE `user_bans`;
TRUNCATE TABLE `user_devices`;
TRUNCATE TABLE `login_bonus_masters`;
TRUNCATE TABLE `login_bonus_reward_masters`;
TRUNCATE TABLE `user_login_bonuses`;
TRUNCATE TABLE `present_all_masters`;
TRUNCATE TABLE `user_present_all_received_history`;
TRUNCATE TABLE `user_presents`;
TRUNCATE TABLE `gacha_masters`;
TRUNCATE TABLE `gacha_item_masters`;
TRUNCATE TABLE `user_items`;
TRUNCATE TABLE `user_cards`;
TRUNCATE TABLE `item_masters`;
TRUNCATE TABLE `version_masters`;
